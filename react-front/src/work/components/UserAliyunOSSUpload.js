import { Tooltip,Divider,Spin,Upload,InputNumber,Radio,Slider,Tag,Input,Pagination,Collapse,Avatar,message,Select,Modal,Checkbox,Alert,Switch } from 'antd';
    ...
    render() {
        ...
        return (
            <div style={{width:"100%",textAlign:"center",alignItems:"center",justifyContent: "center",display: "flex",flexDirection:"column"}}>
                <Upload {...props}>
                    {fileList.length >= 1 ? null : <span style={{width:300}} icon="upload">
