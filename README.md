...
合计38台服务器，以及一台最低配置的mysql数据库，实际上由于大部分只需要选用最低配置的抢占式服务器，实际情况下，对于开仓服务器和ws服务器，我购买了高主频类型的服务器，有一倍速度的提升，其他的行情和数据录取服务器并无必要进行这个优化，综合成本一个月不足3000元人民币，大头在流量费用，基本可以满足大部分量化的风控和延迟需求
