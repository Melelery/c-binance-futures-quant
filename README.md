...
这里顺便引申出一个交易服务器发出订单的方式，有两种，一种是直接在交易服务器上发出，每台交易服务器承担1/5的交易量，另外一个是做一个trade 的web服务器，trade web服务器会以第一次收到交易服务器
发出的交易信号为开仓条件，第一次即开出100%的交易量，两种方式各有适用的地方和优势，需要自行抉择。
